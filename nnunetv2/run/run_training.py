...
def run_training_entry():
    ...
    parser.add_argument('-dataset_name_or_id', type=str,default='100', required=False,help="Dataset name or ID to train with")
    parser.add_argument('-configuration', type=str,default='2d', required=False,help="Configuration that should be trained")
    parser.add_argument('-fold', type=str,default='0', required=False,help='Fold of the 5-fold cross-validation. Should be an int between 0 and 4.')
